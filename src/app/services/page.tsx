...
export default function Services(){
    return(
        <div className="bg-slate-300">
           ...
           <p>Stylish Winter Dresses Collection 2024<br></br>
           Welcome to our Winter Collection 2024! As the temperature drops, it's time to update your wardrobe with the latest in winter fashion. Our collection features an array of stylish and fashionable dresses designed to keep you warm and chic. Explore unstitched and stitched options, including embroidered shawls, woolen suits, velvet dresses, and much more.</p>
